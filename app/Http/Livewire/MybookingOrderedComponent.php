...
class MybookingOrderedComponent extends Component
{
    use WithPagination;
    ...
    {
        $bookings = Booking::where('status', 2)->where('user_id', Auth::user()->id)->paginate(5);
        return view('livewire.mybooking-ordered-component', ['bookings' => $bookings])->layout('layouts.base');
    }
}
