                            ...
                            <div class="thinborder-ontop">
                                ...
                                <form id="userregisterationform" method="POST" action="{{ route('register')}}"> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" name="registeras" id="registeras" required="">
                                                <option value="">เลือกสิทธ์การใช้งาน</option>
                                                <option value="CST">ลูกค้า</option>
                                                <option value="SVP">ร้านบริการ</option>
                                            </select>
                                        </div>
                                    </div>
