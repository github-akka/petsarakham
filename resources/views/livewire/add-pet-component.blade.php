                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{ route('all.pet')}}" class= "btn btn-info pull-right">All Pets</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <form class="form-horizontal" wire:submit.prevent="createNewPet" >
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="file" class="form-control-file" name="pet_image" id="pet-image" wire:model="pet_image" />
                                                    @error('pet_image') <p class="text-danger">{{$message}}</p> @enderror
                                                    @if($pet_image)
                                                        <img src="{{$pet_image->temporaryUrl()}}" width="60"/>
                                                    @endif
                                                </div>
                                            </div>
