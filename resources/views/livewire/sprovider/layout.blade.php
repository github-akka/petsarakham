                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> ++06666666</a></li>
                    ...
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            ...
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Mahasarakham , Thailand</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        @auth
                            ...
                            <li class="login-form"> <a href="#" title="Register">My Account : {{ Auth::user()->name }}</a>
                                <ul class="drop-down one-column hover-fade">
                                    ...
                                    <li><a href="{{ route('sprovider.room_service') }}">Profile</a></li>
                                    <li><a href="{{ route('admin.all_services') }}">All Services</a></li>
                                    <li><a href="{{ route('chatify') }}">Message</a></li>
                                    <li><a href="{{ route('sprovider.room_service') }}">Manage Room Service</a></li>
                            ...
                            <li class="login-form"> <a href="#" title="Register">My Account : {{ Auth::user()->name }}</a>
                                <ul class="drop-down one-column hover-fade">
                                    ...
                                    <li><a href="{{ route('sprovider.room_service') }}">Profile</a></li>
                                    <li><a href="{{ route('chatify') }}">Message</a></li>
                                    <li><a href="{{ route('pets.all') }}">Manage Pets</a></li>
                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">contact@</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">++6055</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">++605</a>
                            </li>
                        </ul>
