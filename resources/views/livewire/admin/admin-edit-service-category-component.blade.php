                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" wire:submit.prevent="updateServiceCategory" >
                                            ...
                                            <div class="form-group">
                                                <lable for="name" class="control-lable col-sm-3">Category Name: </lable>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <lable for="slug" class="control-lable col-sm-3">Category Slug: </lable>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <lable for="image" class="control-lable col-sm-3">Category Image: </lable>
                                                <div class="col-sm-9">
